...
# sub-7TNNNLLYYYYMMDD_ses-01_task-blank_run-01_bold.1D
...
input_folder = Path("/autofs/cluster/vagabond/USERS/MARIO/Projects/7T/sourcedata/derivatives/spm/3_generated1D")
output_folder = Path("/autofs/cluster/vagabond/USERS/MARIO/Projects/7T/sourcedata/derivatives/spm/4_names_corrected")
...
for src in sorted(input_folder.glob("*.1D")):
