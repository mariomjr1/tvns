...
base_firstlvl = '/autofs/cluster/vagabond/USERS/MARIO/Projects/7T/sourcedata/derivatives/spm/8_first_level_vanilla';
...
outputDir     = '/autofs/cluster/vagabond/USERS/MARIO/Projects/7T/sourcedata/derivatives/spm/9_first_level_t1w_vanilla';
...
for i = 1:numel(sublist)
    ...
    for t = 1:numel(tasks)
        ...
        % Canonical HRF Only (classic Stim > baseline)
        ...
        % ------------------------------------------------------------
        % 5) Contrasts: Stim > baseline (no-stim) and Stim < baseline
        % ------------------------------------------------------------
        matlabbatch = [];
        matlabbatch{1}.spm.stats.con.spmmat = {spm_mat_file};
        matlabbatch{1}.spm.stats.con.delete = 1;

        matlabbatch{1}.spm.stats.con.consess{1}.tcon.name    = 'Stim > baseline';
        matlabbatch{1}.spm.stats.con.consess{1}.tcon.weights = 1;
        matlabbatch{1}.spm.stats.con.consess{1}.tcon.sessrep = 'none';

        matlabbatch{1}.spm.stats.con.consess{2}.tcon.name    = 'Stim < baseline';
