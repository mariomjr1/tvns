...
def create_visualization(mat_path, json_path, output_path,
    ...
    json_dir       BIDS func dir with *_bold.json sidecars
                   (default: folder of pseudotime_mapping.json).
    dicominfo_path explicit dicominfo_ses-01.tsv path (e.g. from .heudiconv)
                   (default: <json_dir>/dicominfo_ses-01.tsv).
    """
...
def main():
    ...
    ap = argparse.ArgumentParser(
        description="Plot physiological recording with acquisition timeline (block1).")
    ap.add_argument("mat_file",     help="Full path to the session .mat file (block1)")
